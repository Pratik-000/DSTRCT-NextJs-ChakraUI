...
const LinkItems = [
    { name: 'Home', icon: FiHome, router: "/" },
    { name: 'Trending', icon: FiTrendingUp, router: "/trending" },
    { name: 'Explore', icon: FiCompass, router: "/explore" },
    { name: 'Favourites', icon: FiStar, router: "/favourites" },
    { name: 'Settings', icon: FiSettings, router: "/settings" },
]
